...
import { toCollaboratorDisplayModel } from "../../../../mappers/trips/shares/collaborators/collaboratorDisplayMapper";

export function CollaboratorCard({ collaborator, removing, onRemove }) {
  const displayCollaborator = toCollaboratorDisplayModel(collaborator);
        ...
        <div className="min-w-0">
          <div className="mb-3 flex flex-wrap items-center gap-2">
            <span className="rounded-full border border-[#746454] bg-[#6f5f48] px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-[#fffaf3]">
              {displayCollaborator.accessLevelLabel} access
            </span>
            ...
            <span className="rounded-full border border-[#cdbca9] bg-[#f8f3ec] px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-[#4b4036]">
              User #{displayCollaborator.userId}
            </span>
          </div>
          ...
          <p className="mt-3 text-xs font-semibold text-[#9a8b7b]">
            Added: {displayCollaborator.createdAtDisplay}
          </p>
        </div>
