...
namespace TravelPlanner.Contracts.Interfaces.Notifications
{
    ...
    public interface INotificationService : IService
    {
        ...
        Task<ServiceResultDto<int>> GetTriggeredReminderCountAsync(int requestUserId, bool isAdmin);
        ...
        Task<ServiceResultDto> DeleteRemindersByTravelPlanAsync(int travelPlanId);
    }
}