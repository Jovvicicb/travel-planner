...
namespace TravelPlanner.Api.Controllers
{
    ...
    public class TripsController : ControllerBase
    {
        ...
        [HttpGet("{tripId:int}/shares")]
        public async Task<IActionResult> GetShares(int tripId)
        {
            var userContext = UserContextHelper.GetUserContext(User);
            ...
            var result = await tripService.GetSharesAsync(
                tripId,
                userContext.Value.UserId,
                userContext.Value.IsAdmin
            );
        ...
        [HttpDelete("{tripId:int}/shares/{shareId:int}")]
        public async Task<IActionResult> DeactivateShare(int tripId, int shareId)
        {
            var userContext = UserContextHelper.GetUserContext(User);
            ...
            var result = await tripService.DeactivateShareAsync(
                tripId,
                shareId,
                userContext.Value.UserId,
                userContext.Value.IsAdmin
        ...
        [HttpGet("{tripId:int}/collaborators")]
        public async Task<IActionResult> GetCollaborators(int tripId)
        {
            ...
            var result = await tripService.GetCollaboratorsAsync(
                tripId,
                userContext.Value.UserId,
                userContext.Value.IsAdmin
            );
        ...
        [HttpDelete("{tripId:int}/collaborators/{userId:int}")]
        public async Task<IActionResult> RemoveCollaborator(int tripId, int userId)
        {
            ...
            var result = await tripService.RemoveCollaboratorAsync(
                tripId,
                userId,
                userContext.Value.UserId,
                userContext.Value.IsAdmin
